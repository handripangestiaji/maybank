...
class facebook_model extends CI_Model
{
    ...
    */
    ...
    function GetChannelAction($filter, $is_where_in = false){
        $this->db->select("a.*, b.username, b.display_name, c.comment_content, d.messages, d.solved_message, d.assign_to, e.display_name as assign_name, f.display_name as solved_name");
