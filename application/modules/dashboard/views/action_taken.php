<div id="modal-action-log-<?=$post->social_stream_type=='facebook_conversation'? $post->post_id: $post->post_stream_id; echo $unique_id; ?>" class="modal modalDialog hide fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
