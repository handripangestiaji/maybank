                            ...
                            <?php
                                ...
                                '<li>
                                    ...
                                    <p class="headLine">
                                        ...
                                        <span>posted a <a href="#">new post</a></span>
                                        <i class="icon-circle"></i>
                                        <span>Agt 17, 2013 06:34 am</span>
                                        <i class="icon-play-circle moreOptions pull-right"></i>
                                    </p>
                                    <p>"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco..."</p>
                                    <p><button type="button" class="btn btn-warning btn-mini">OPEN</button> <button type="button" class="btn btn-primary btn-mini">LIKE</button></p>
                                    <p><a data-toggle="modal" role="button" href="#modalDialog"><i class="icon-eye-open"></i> 3 Engagement</a> | <a data-toggle="modal" role="button" href="#modalDialog"><i class="icon-thumbs-up-alt greyText"></i> 24 like this</a></p>
                                    <h4 class="filled">
