                ...
                if($comment[$j]->attachment != ''):
                    ...
                    if(isset($attachment->image_data)){
                        if(isset($attachment->image_data->url))
                            $att_to_print = '<img src="'.$attachment->image_data->url.'" style="width:60%;" />';
                        else
                            $att_to_print = '<img src="https://www.facebook.com/ajax/messaging/attachment.php?attach_id='.$attachment->id.'&mid='.substr($comment[$j]->detail_id_from_facebook, 2).'&preview=1" style="width:60%;" />';
                    }
                    else 
