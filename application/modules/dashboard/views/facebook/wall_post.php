...
//                print_r($attachment);?>
    ...
    <?php }else{?>
  <button type="button" class="btn <?php echo count($fb_feed[$i]->channel_action) == 0 ? "btn-warning btn-mini no-cursor indicator" : "btn-inverse btn-mini no-cursor indicator" ?>"><?php echo count($fb_feed[$i]->reply_post) == 0 ? 'OPEN' :  'Replied '?></button>        
    <?php }
