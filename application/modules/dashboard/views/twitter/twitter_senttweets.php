...
?>
    <li>
        <div class="circleAvatar"><img src="<?php echo $senttweets[$i]->user->profile_image_url;?>" alt=""></div>
        <p class="headLine">
            <span class="author"><?php echo $senttweets[$i]->user->name; ?></span>
    ...
    <?php if ($senttweets[$i]->retweeted>0) { ?>
        <button type="button" class="btn btn-inverse btn-mini"><i class="icon-retweet">&nbsp;</i></button>
    <?php } ?>    
    <?php if ($senttweets[$i]->favorited=='true') { ?>
        <button type="button" class="btn btn-inverse btn-mini"><i class="icon-star">&nbsp;</i></button>
    <?php } ?></p>
    
    <p><a data-toggle="modal" role="button" href="#modalDialogEngagement<?php echo $i; ?>"><i class="icon-eye-open"></i> Engagement</a> | <a data-toggle="modal" role="button" href="#modaltweet<?php echo $i; ?>" ><i class="icon-retweet greyText"></i><?php echo $senttweets[$i]->retweeted; ?> re-tweets</a></p>
    ...
    <div id="modalDialogEngagement<?php echo $i; ?>" class="modal modalDialog hide fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-header">
            ...
            <h3><?php echo $senttweets[$i]->user->name; ?></h3>
        </div>
    ...
    <h4 class="filled">
        ...
        <div class="pull-right">
            <form class="contentForm" action="<?php echo base_url('/index.php/dashboard/twitteraction');?>" method="post">
                ...
                <input type="hidden" name="str_id" value="<?php echo $senttweets[$i]->id_str; ?>" />
                <input type="hidden" name="id" value="<?php echo $senttweets[$i]->id; ?>" />
                <input type="hidden" name="userid" value="<?php echo $senttweets[$i]->user->id_str; ?>" />
                <input type="hidden" name="followid" value="<?php echo $senttweets[$i]->in_reply_to_user_id_str; ?>" />
               </form>    
        </div>
        <br clear="all" />
    </h4>
        ...
        <div class="modal-body">
                    ...
                    <div class="reply filled hide">
                        <form class="contentForm" action="<?php echo base_url('/index.php/dashboard/twitterAction');?>" method="post">
                            <div class="controlButton pull-right"><i class="icon-remove-sign hide-form"></i></div>
                            <textarea style="width: 95%;" rows="9" id="content" name="content"></textarea>
                            <input type="hidden" name="friendid" value="<?php echo $senttweets[$i]->user->id_str; ?>" />
