...
if(is_array($senttweets))
{
                                ...
                                echo
                                '<li>
                                    <div class="circleAvatar"><img src="'.$senttweets[$i]->user->profile_image_url.'" alt=""></div>
                                    <p class="headLine">
                                        <span class="author">'.$senttweets[$i]->user->name.'</span>
                                        <i class="icon-circle"></i>
                                        <span>mentions</span>
                                        <i class="icon-circle"></i>
                                        <span>'.str_replace('+0000','',$senttweets[$i]->created_at).'</span>
                                        <i class="icon-play-circle moreOptions pull-right"></i>
                                    </p>
                                    <p>'.$senttweets[$i]->text.'</p>
                                    <p><button type="button" class="btn btn-warning btn-mini">OPEN</button></p>
                                    <p><a data-toggle="modal" role="button" href="#modalDialog"><i class="icon-eye-open"></i> Engagement</a> | <a data-toggle="modal" role="button" href="#modalDialog"><i class="icon-retweet greyText"></i>'.$senttweets[$i]->retweeted.' re-tweets</a></p>
                                    <h4 class="filled">
	...
	echo "<li>".$senttweets->errors[0]->message."</li>";
}
                            ?>