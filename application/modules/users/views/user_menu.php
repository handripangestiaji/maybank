...
<?php if(IsRoleFriendlyNameExist($this->user_role,'User Management_Role_View')):?>
    <a href="<?php echo base_url(); ?>users/menu_role"><button class="btn <?php if($this->uri->segment(2) == 'menu_role'){echo 'btn-primary'; } ?>" type="button"/>Role</button></a><br />
<?php endif;?>
<?php if(IsRoleFriendlyNameExist($this->user_role, 'User Management_Group_View')):?>
    <a href="<?php echo base_url() ?>users/menu_group"><button class="btn <?php if($this->uri->segment(2) == 'menu_group'){echo 'btn-primary'; } ?>" type="button"/>Group</button></a>
<?php endif;?>
<?php if(IsRoleFriendlyNameExist($this->user_role, array('Social Channel Management_Country',
    ...
    <a href="<?php echo base_url() ?>users/country"><button class="btn <?php if($this->uri->segment(2) == 'country'){echo 'btn-primary'; } ?>" type="button">Country</button></a>
<?php endif;?>
